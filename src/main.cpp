...
uint256 hashGenesisBlock("0x9add87743cec495964c51fb254f39340a0c16591a680b13dd1b0ee3ecdcc07f9");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb5b3473de8d49d7a32f43bed630f9b4dcc032ce50ffb2df386e42f01c0fef65c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "BBC News 08/Apr/2014 Ukraine crisis: Ukraine in bid to retake buildings";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040184710da689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1396949742;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 231338;

        if (fTestNet)
        {
            block.nTime    = 1396784416;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb64c1eb1a20d15ec7a2697aef3316022248540e448605b2c36c779d9fda38e0f"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc1, 0xb7, 0xda }; // Sportcoin: increase each by adding 2 to bitcoin's value.
